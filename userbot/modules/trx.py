...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"`#Lazaruz Sedang Melakukan Proses Transaksi Dengan `[{name0}](tg://user?id={uid})")
...
async def disapprovepm(disapprvpm):
    ...
    await disapprvpm.edit(
        f"`#Lazaruz Telah Selesai Melakukan Transaksi Dengan` [{name0}](tg://user?id={disapprvpm.chat_id})")
